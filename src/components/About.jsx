  ...
  return (
    <>
      ...
      <p ref={paragraphRef} className="mt-4 text-secondary text-[17px] max-w-3xl leading-[30px]">
        ...
        like React, Node.js, and Next.js. I'm a quick learner and collaborate closely with clients to create efficient, 
      ...
      <div className="mt-20 grid grid-cols-1 sm:grid-cols-3 lg:[grid-template-columns:repeat(auto-fit,minmax(250px,1fr))] gap-10 justify-items-center">
  {services.map((service, index) => (
    <ServiceCard key={service.title} index={index} {...service} />
  ))}
</div>
